...
void example_ckks_basics()
{
    ...
    */
    ...
    //方案三Start
    //keygen1.set_secret_key(secret_key_sum);
    keygen1.set_secret_key(secret_key1);
    PublicKey veca = keygen1.generate_veca(false);
    PublicKey vecb1 = keygen1.generate_pk_with_veca(false);

    keygen1.set_secret_key(secret_key2);
    PublicKey vecb2 = keygen1.generate_pk_with_veca(false);

    keygen1.set_secret_key(secret_key3);
    PublicKey vecb3 = keygen1.generate_pk_with_veca(false);
    ...
    keygen1.add_public_key(vecb2);
    keygen1.add_public_key(vecb3);
    Encryptor encryptor_sum(context, keygen1.get_veca());
